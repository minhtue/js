!(function (e, t) {
    ...
    return (function (e) {
                                            ...
                                            (r.onreadystatechange = function () {
                                                if (4 === r.readyState) {
                                                    ...
                                                    var o = u.parseHeaders(r.getAllResponseHeaders()),
                                                        i = { body: e, code: r.status, headers: o };
        ...
        function (e, t) {
            e.exports =
                '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="40"><g fill="#A8ACB8" fill-rule="evenodd"><path fill-rule="nonzero" d="M17 0l15 14V3v34a3 3 0 0 1-3 3H3a3 3 0 0 1-3-3V3a3 3 0 0 1 3-3h20-6zm0 2H3a1 1 0 0 0-1 1v34a1 1 0 0 0 1 1h26a1 1 0 0 0 1-1V14H17V2zm2 10h7.926L19 4.602V12z"></path><path d="M7 22h18v2H7zm0 4h18v2H7zm0 4h18v2H7z"></path></g></svg>';
        },
        function (e, t) {
            e.exports =
            ...
            var y = (function () {
                function e(t) {
                    ...
                    !(function (e, t) {
                        ...
                        (this.api = i),
                        (this.nodes = { wrapper: null, button: null, title: null }),
                        (this._data = { file: {}, title: "" }),
                        (this.config = { endpoint: o.endpoint || "", field: o.field || "file", types: o.types || "*", buttonText: o.buttonText || "Select file to upload", errorMessage: o.errorMessage || "File upload failed" }),
                        (this.data = r),
                        (this.uploader = new a({
                            config: this.config,
                            onUpload: function (e) {
                    ...
                    (r = [
                        {
                            key: "toolbox",
                            get: function () {
                                return { icon: c.a, title: "Attaches" };
                            },
                        },
                        {
                    ...
                    (n = [
                        {
                            ...
                            value: function (e) {
                                if (this.pluginHasData()) {
                                    ...
                                    Object.assign(this.data, { title: t });
                                }
                                return this.data;
                            },
                        },
                        ...
                        },
                        {
                            ...
                            value: function () {
                                return (
                                    "" !== this.data.title ||
                                    Object.values(this.data.file).some(function (e) {
                                        return void 0 !== e;
                                    })
                                );
                            },
                            ...
                            value: function (e) {
                                ...
                                if (t.success && t.file) {
                                    var n = t.file,
                                        ...
                                        o = n.name,
                                        i = n.size;
                                    (this.data = { file: { url: r, extension: o.split(".").pop(), name: o, size: i }, title: o }),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var e = this.data.file.extension || "",
                                    t = this.EXTENSIONS[e],
                                    n = this.make("div", this.CSS.fileIcon, { innerHTML: t ? d.a : u.a });
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                if ((o && ((this.nodes.title = this.make("div", this.CSS.title, { contentEditable: !0 })), (this.nodes.title.textContent = o), i.appendChild(this.nodes.title)), n)) {
                                    var a,
                                        s,
                                        c = this.make("div", this.CSS.size);
                                ...
                                var l = this.make("a", this.CSS.downloadButton, { innerHTML: h.a, href: r, target: "_blank", rel: "nofollow noindex noreferrer" });
                        ...
                        },
                        {
                            key: "uploadingFailed",
                            value: function (e) {
                                this.api.notifier.show({ message: e, style: "error" }), this.removeLoader();
                            },
                        },
                        {
                            key: "moveCaretToEnd",
