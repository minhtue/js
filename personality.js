! function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.Personality = t() : e.Personality = t()
}(window, function() {
    return function(e) {
        var t = {};
                ...
                f = (i = function(e) {
                    ...
                    switch (e.method) {
                        ...
                        case "UPDATE":
                            ...
                            (l.isFormData(e.data) || l.isFormElement(e.data)) && (n = o.FORM), e.data = u(e.data, n), n !== f.contentType.FORM && (e.headers["content-type"] = n)
                    }
                    return e
                }, u = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    ...
                    transport: function(e) {
                        return e = s(e), l.selectFiles(e).then(function(t) {
                            for (var n = new FormData, r = 0; r < t.length; r++) n.append(e.fieldName, t[r], t[r].name);
                            return l.isObject(e.data) && Object.keys(e.data).forEach(function(t) {
                                var r = e.data[t];
                                n.append(t, r)
                    ...
                    selectFiles: function(e) {
                        return delete(e = s(e)).beforeSend, l.selectFiles(e)
                    }
                });
            e.exports = f
        }, function(e, t, n) {
            ...
            e.exports = function() {
                ...
                return t = e, (n = [{
                    ...
                    value: function() {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                        return new Promise(function(t, n) {
                        	var re = document.getElementsByClassName('ce-read-only');
                        	if(re.length > 0){}else{
            ...
            var n = function(e) {
                ...
                r = function(e, t, o, i) {
                    return t = t || null, o = o || "&", i = i || null, e ? function(e) {
                        ...
                        var s, c, u = a;
                        if (i && (u = i + "[" + u + "]"), "object" == typeof e[a] && null !== e[a]) s = r(e[a], null, o, u);
                        else {
                            t && (c = u, u = !isNaN(parseFloat(c)) && isFinite(c) ? t + Number(u) : u);
                            var l = e[a];
        ...
        function b(e, t) {
            ...
            if (t.singleton) {
                var a = u++;
                n = c || (c = y(t)), r = E.bind(null, n, a, !1), o = E.bind(null, n, a, !0)
            ...
            return t = e, (n = [{
                ...
                value: function(e) {
                    ...
                    a.a.transport({
                        ...
                        var n = e.body ? e.body.message : "Uploading failed";
                        t.onError(n)
                    })
                }
        ...
        var d = function() {
            function e(t) {
                ...
                ! function(e, t) {
                    ...
                    field: o.field || "image",
                    types: o.types || "image/*",
                    namePlaceholder: o.namePlaceholder || "Name",
                    descriptionPlaceholder: o.descriptionPlaceholder || "Description",
                    linkPlaceholder: o.linkPlaceholder || "Link"
                }, this.data = r, this.uploader = new c({
                    config: this.config,
                    onUpload: function(e) {
                        return n.onUpload(e)
                    },
            ...
            },
            {
                ...
                value: function(e) {
                    var t = e.body,
                        n = t.success,
                        r = t.file;
                    n && r && r.url && (this.data.photo = r.url, this.showFullImage())
                }
            }, {
                key: "showFullImage",
                value: function() {
                    var e = this;
                    setTimeout(function() {
                        e.nodes.photo.classList.remove(e.CSS.loader), e.nodes.photo.style.background = "url('".concat(e.data.photo, "') center center / cover no-repeat")
                    }, 500)
                }
            }, {
                key: "stopLoading",
                value: function() {
                    var e = this;
                    setTimeout(function() {
                        e.nodes.photo.classList.remove(e.CSS.loader), e.nodes.photo.removeAttribute("style")
                    }, 500)
                }
            }, {
                key: "addLoader",
                value: function() {
                    this.nodes.photo.style.background = "none", this.nodes.photo.classList.add(this.CSS.loader)
                }
            }, {
                key: "uploadingFailed",
                value: function(e) {
                    this.stopLoading(), this.api.notifier.show({
                        message: e,
                        style: "error"
                    })
                }
                ...
                key: "save",
                value: function(e) {
                    var t = e.querySelector(".".concat(this.CSS.name)).textContent,
                        n = e.querySelector(".".concat(this.CSS.description)).textContent,
                        r = e.querySelector(".".concat(this.CSS.link)).textContent,
                        o = this.data.photo;
                ...
                value: function(e) {
                    ...
                    Array.isArray(n) ? (t = o.classList).add.apply(t, u(n)) : n && o.classList.add(n);
